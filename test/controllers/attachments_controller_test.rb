...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { file: @attachment.file, project_id: @attachment.project_id } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { file: @attachment.file, project_id: @attachment.project_id } }
